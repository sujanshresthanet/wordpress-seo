...
const ProminentWords = ( { location } ) => { // eslint-disable-line complexity
	...
	const prominentWords = useSelect( select => select( "yoast-seo/editor" ).getProminentWords(), [] );
	...
	return (
		<div className="yoast-prominent-words">
			...
			{ ! shouldUpsell && <p>{ __( "The following words occur the most in the content. These give an indication of what your content focuses on. If the words differ a lot from your topic, you might want to rewrite your content accordingly.", "wordpress-seo" ) }</p> }
			...
			<DataModel
				data={ shouldUpsell ? prominentWordsUpsell : prominentWords }
